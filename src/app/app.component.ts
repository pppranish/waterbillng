...
export class AppComponent implements OnInit {
  ...
  private updateHeaderAndNavbarVisibility(url: string): void {
    const excludedRoutes = ['login', 'signup' , 'meter-reading','print-bill','admin','workflow-users' ,'create-user', 'dashboard', 'connection' ,'water-consumer-list', 'consumption', "user" , 'water-bill', 'sewage-bill' , 'payment-history', 'message-inbox' , 'user-management' , 'error-logs', 'applicant' ];
